...
import org.codelibs.sastruts.core.exception.FileAccessException;
...
public class DynamicProperties extends Properties {
    ...
    public DynamicProperties(final String path) {
        ...
        if (StringUtil.isEmpty(path)) {
            throw new FileAccessException("ESSC0004");
        }
        ...
        if (!propertiesFile.exists()) {
            ...
            throw new FileAccessException("ESSC0007", new Object[] { path });
        }
        load();
    }
